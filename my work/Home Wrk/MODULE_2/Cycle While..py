...
while index < len(my_list) and my_list[index] >= 0:
    if my_list[index] > 0:
        print(f'индекс: {index}, число : {my_list[index]}')
    index += 1

# + решение с прохождением всего списка, отметая только отрицательные числа
# my_list = [42, 69, 322, 13, 0, 99, -5, 9, 8, 7, -6, 5]
# index = 0
#
...
#         print(f'Индекс: {index}, число : {my_list[index]}')
#     else:
#         print(f'Индекс: {index}, число : - не интересует')
#
#     index += 1
